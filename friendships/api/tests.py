...
class FriendshipApiTests(TestCase):
    ...
    def setUp(self):
        ...
        for i in range(2):
            follower = self.create_user('user2_follower{}'.format(i), 'follower{}@twitter.com'.format(i))
            Friendship.objects.create(from_user=follower, to_user=self.user2)
        for i in range(3):
            following = self.create_user('user2_following{}'.format(i), 'follower{}@twitter.com'.format(i))
        ...
        for i in range(page_size * 2):
            ...
            if follower.id % 2 == 0:
                Friendship.objects.create(
                    from_user=self.dongxie, to_user=follower)
